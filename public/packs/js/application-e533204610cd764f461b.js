...
/* WEBPACK VAR INJECTION */(function($) {var MovieListFilter = {
  ...
  setup: function setup() {
    ...
    var labelAndCheckbox = $('<label for="filter">Only movies suitable for children</label>' + '<input type="checkbox" id="filter"/>');
...
/* WEBPACK VAR INJECTION */(function($) {var MoviePopup = {
  setup: function setup() {
    ...
    $(document).on('click', '#More', MoviePopup.getMovieInfo);
  },
...
/******/ });
//# sourceMappingURL=application-e533204610cd764f461b.js.map